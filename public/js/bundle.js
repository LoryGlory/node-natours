...
})(
  {
    ...
    '../../node_modules/core-js/modules/_to-length.js': [
      function (require, module, exports) {
        ...
        module.exports = function (it) {
          return it > 0
            ? min(toInteger(it), 0x1fffffffffffff)
      ...
      [
        function (require, module, exports) {
          ...
          module.exports = function (original, length) {
            return new (speciesConstructor(original))(
              length
            );
          };
        },
    ...
    '../../node_modules/core-js/modules/core.get-iterator-method.js':
      [
        function (require, module, exports) {
          ...
          var Iterators = require('./_iterators');
          module.exports =
            require('./_core').getIteratorMethod =
              function (it) {
                if (it != undefined)
                  return (
                    it[ITERATOR] ||
    ...
    '../../node_modules/core-js/modules/_object-keys-internal.js':
      [
        function (require, module, exports) {
          var has = require('./_has');
          var toIObject = require('./_to-iobject');
          var arrayIndexOf = require('./_array-includes')(
            false
          );
          var IE_PROTO =
            require('./_shared-key')('IE_PROTO');
        ...
        module.exports = function (
          ...
          if ($anyNative) {
            ...
            if (
              ...
              if (
                !LIBRARY &&
                typeof IteratorPrototype[ITERATOR] !=
                  'function'
              )
                hide(
                  IteratorPrototype,
      ...
      function (require, module, exports) {
        ...
        module.exports = function (
          ...
          if (
            ...
            var ACCEPT_ITERABLES = $iterDetect(function (
              iter
            ) {
              new C(iter);
          ...
          O[NAME] = C;
          $export(
            $export.G + $export.W + $export.F * (C != Base),
            O
          );
      ...
      function (require, module, exports) {
        ...
        $export($export.S, 'Math', {
          cbrt: function cbrt(x) {
            return (
              sign((x = +x)) * Math.pow(Math.abs(x), 1 / 3)
            );
          },
        });
      },
    ...
    '../../node_modules/core-js/modules/es6.number.constructor.js':
      [
        function (require, module, exports) {
          ...
          var BROKEN_COF =
            cof(require('./_object-create')(proto)) ==
            NUMBER;
    ...
    '../../node_modules/core-js/modules/_parse-float.js': [
      function (require, module, exports) {
        ...
        module.exports =
          1 /
            $parseFloat(require('./_string-ws') + '-0') !==
          -Infinity
    ...
    '../../node_modules/core-js/modules/es7.object.entries.js':
      [
        function (require, module, exports) {
          ...
          var $export = require('./_export');
          var $entries = require('./_object-to-array')(
            true
          );
    ...
    '../../node_modules/core-js/modules/es7.object.values.js':
      [
        function (require, module, exports) {
          // https://github.com/tc39/proposal-object-values-entries
          var $export = require('./_export');
          var $values = require('./_object-to-array')(
            false
          );
        ...
        var onUnhandled = function (promise) {
          task.call(global, function () {
            ...
            if (unhandled) {
              ...
              promise._h =
                isNode || isUnhandled(promise) ? 2 : 1;
            }
    ...
    '../../node_modules/core-js/modules/es6.reflect.construct.js':
      [
        function (require, module, exports) {
          ...
          $export(
            $export.S +
              $export.F * (NEW_TARGET_BUG || ARGS_BUG),
            'Reflect',
            {
      ...
      [
        function (require, module, exports) {
          ...
          function set(
            ...
            var receiver =
              arguments.length < 4 ? target : arguments[3];
            var ownDesc = gOPD.f(
              anObject(target),
              propertyKey
            );
      ...
      [
        function (require, module, exports) {
          ...
          module.exports = function (S, index, unicode) {
            return (
              index + (unicode ? at(S, index).length : 1)
            );
          };
        },
        {
    ...
    '../../node_modules/core-js/modules/_regexp-exec.js': [
      function (require, module, exports) {
        ...
        var UPDATES_LAST_INDEX_WRONG = (function () {
          ...
          return (
            re1[LAST_INDEX] !== 0 || re2[LAST_INDEX] !== 0
          );
        })();
            ...
            function (
              ...
              return [
                ...
                function (regexp, limit) {
                  ...
                  if (lim === 0) return [];
                  if (S.length === 0)
                    return callRegExpExec(splitter, S) ===
                      null
                      ? [S]
                      : [];
                  var p = 0;
    ...
    '../../node_modules/core-js/modules/es6.symbol.js': [
      function (require, module, exports) {
        ...
        var wrap = function (tag) {
          var sym = (AllSymbols[tag] = _create(
            $Symbol[PROTOTYPE]
          ));
          sym._k = tag;
          return sym;
        ...
        if (!USE_NATIVE) {
          ...
          require('./_object-gopn').f = gOPNExt.f =
            $getOwnPropertyNames;
          require('./_object-pie').f =
            $propertyIsEnumerable;
          require('./_object-gops').f =
      ...
      [
        function (require, module, exports) {
          ...
          $export(
            $export.P +
              $export.F *
                require('./_fails-is-regexp')(ENDS_WITH),
            'String',
            {
            ...
            'String',
            {
              ...
              fromCodePoint: function fromCodePoint(x) {
                ...
                while (aLen > i) {
                  code = +arguments[i++];
                  if (
                    toAbsoluteIndex(code, 0x10ffff) !== code
                  )
                    throw RangeError(
      ...
      [
        function (require, module, exports) {
          ...
          $export(
            $export.P +
              $export.F *
                require('./_fails-is-regexp')(INCLUDES),
            'String',
            {
              includes: function includes(
      ...
      [
        function (require, module, exports) {
          ...
          $export(
            $export.P +
              $export.F *
                require('./_fails-is-regexp')(STARTS_WITH),
            'String',
            {
      ...
      function (require, module, exports) {
        ...
        if (!$typed.ABV) {
          ...
          if (
            ...
            var ArrayBufferProto = ($ArrayBuffer[
              PROTOTYPE
    ...
    '../../node_modules/core-js/modules/es6.typed.array-buffer.js':
      [
        function (require, module, exports) {
          ...
          $export(
            $export.S + $export.F * !$typed.CONSTR,
            ARRAY_BUFFER,
            {
    ...
    '../../node_modules/core-js/modules/_typed-array.js': [
      function (require, module, exports) {
        ...
        if (require('./_descriptors')) {
          ...
          var $setDesc = function defineProperty(
            target,
            key,
            desc
          ) {
          ...
          module.exports = function (
            ...
            CLAMPED = !!CLAMPED;
            var NAME =
              KEY + (CLAMPED ? 'Clamped' : '') + 'Array';
            var GETTER = 'get' + KEY;
            var SETTER = 'set' + KEY;
            var TypedArray = global[NAME];
            var Base = TypedArray || {};
            var TAC =
              TypedArray && getPrototypeOf(TypedArray);
    ...
    '../../node_modules/core-js/modules/_flatten-into-array.js':
      [
        function (require, module, exports) {
          ...
          var toLength = require('./_to-length');
          var ctx = require('./_ctx');
          var IS_CONCAT_SPREADABLE = require('./_wks')(
            'isConcatSpreadable'
          );
    ...
    '../../node_modules/is-buffer/index.js': [
      function (require, module, exports) {
        ...
        function isBuffer(obj) {
          return (
            !!obj.constructor &&
            typeof obj.constructor.isBuffer ===
              'function' &&
      ...
      function (require, module, exports) {
        ...
        module.exports = function xhrAdapter(config) {
          return new Promise(function dispatchXhrRequest(
            ...
            if (
              typeof config.onDownloadProgress ===
              'function'
            ) {
            ...
            if (
              typeof config.onUploadProgress ===
                'function' &&
              request.upload
            ) {
    ...
    '../../node_modules/axios/lib/core/transformData.js': [
      function (require, module, exports) {
         ...
         */
        module.exports = function transformData(
          data,
          headers,
          fns
        ) {
    ...
    '../../node_modules/axios/lib/helpers/combineURLs.js': [
      function (require, module, exports) {
         ...
         */
        module.exports = function combineURLs(
          baseURL,
          relativeURL
        ) {
          return relativeURL
    ...
    '../../node_modules/axios/lib/core/dispatchRequest.js':
      [
        function (require, module, exports) {
           ...
           */
          module.exports = function dispatchRequest(
            config
          ) {
      ...
      function (require, module, exports) {
        ...
        Axios.prototype.request = function request(config) {
          ...
          this.interceptors.request.forEach(
            function unshiftRequestInterceptors(
              interceptor
            ) {
              chain.unshift(
    ...
    'index.js': [
      function (require, module, exports) {
        ...
        var userDataForm = document.querySelector(
          '.form-user-data'
        );
        var userPasswordForm = document.querySelector(
          '.form-user-password'
        ); // DELEGATION
        ...
        function (require, module, exports) {
          ...
          function hmrAcceptRun(bundle, id) {
            ...
            if (
              ...
              cached.hot._disposeCallbacks.forEach(
                function (cb) {
                  cb(bundle.hotData);
                }
              );
            ...
            if (
              ...
              cached.hot._acceptCallbacks.forEach(function (
                cb
              ) {
                cb();
              });
