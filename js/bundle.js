...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibG9yeWdsb3J5IiwiYSI6ImNsZjJrcWd1ZjBqaG8zcmxqMW55djFpNzUifQ.CfPS8MVS7bE8nTF2Y5QYlg';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/loryglory/clf2wh9ln001p01mybaoxmnnv',
    // style URL
    center: [-74.5, 40],
...
function () {
  ...
  _regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          stripe = Stripe('pk_test_51MkCTeJ4LDEkJ919MdG35pCAaSEX6ERRh52bwz70MEDeE2D7EqUqnHN9L7DIfvoCOpnGrDsFoYyKnPRlkYWtjD5Y00NpxwkCEV');
          _context.prev = 1;
          _context.next = 4;
